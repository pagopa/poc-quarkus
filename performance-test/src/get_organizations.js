...
import { getOrganizations, createOrganization, deleteOrganization } from "./modules/orgsEnrollment_client.js";
...
export default function(data) {
	...
	const response = getOrganizations(orgsEnrollmentHost, params);

	console.log(`GetOrganizations ... ${response.status}`);

	check(response, {"GetOrganizations status is 200": (res) => (res.status === 200)}, tag);
}
